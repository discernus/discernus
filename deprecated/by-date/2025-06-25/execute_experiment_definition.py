...
This script has been DEPRECATED as of 2025-06-25.

REPLACEMENT: Use scripts/applications/comprehensive_experiment_orchestrator.py instead

DEPRECATION REASON: Obsolete - superseded by comprehensive orchestrator with:
- YAML + JSON support (this only supports JSON)
- 9-dimensional validation framework (this has basic validation)
- Checkpoint/resume capability (this has none)
- Advanced academic pipeline (this has basic exports)
- Research workspace integration (this has none)
- Transaction safety (this has none)

MIGRATION:
  OLD: python3 scripts/applications/execute_experiment_definition.py experiment.json
  NEW: python3 scripts/applications/comprehensive_experiment_orchestrator.py experiment.yaml

See deprecated/by-date/2025-06-25/DEPRECATION_NOTICE.md for full details.
