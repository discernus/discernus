#!/usr/bin/env python3
"""
Framework Specification Validator

⚠️ DEPRECATED: This validator has been replaced by the unified framework validator.

Use scripts/utilities/unified_framework_validator.py instead.

This legacy validator only supports the old JSON format and lacks support for:
