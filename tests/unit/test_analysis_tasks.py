...
from src.narrative_gravity.tasks import analysis_tasks
from src.narrative_gravity.api.schemas import TaskStatus
from src.narrative_gravity.models.models import Task, Chunk
...
class TestAnalysisTasks:
    ...
    @patch('src.narrative_gravity.tasks.analysis_tasks.analyze_political_spectrum')
    @patch('src.narrative_gravity.tasks.analysis_tasks.analyze_moral_rhetorical_posture')
    @patch('src.narrative_gravity.tasks.analysis_tasks.analyze_civic_virtue')
    @patch('src.narrative_gravity.tasks.analysis_tasks._update_job_progress')
    @patch('src.narrative_gravity.tasks.analysis_tasks._update_chunk_framework_data')
    @patch('src.narrative_gravity.tasks.analysis_tasks.crud')
    @patch('src.narrative_gravity.tasks.analysis_tasks.get_db_session')
