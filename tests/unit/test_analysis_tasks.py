...
from models.models import Task, Chunk
...
class TestAnalysisTasks:
    ...
    @patch('tasks.analysis_tasks.analyze_political_spectrum')
    @patch('tasks.analysis_tasks.analyze_moral_rhetorical_posture')
    @patch('tasks.analysis_tasks.analyze_civic_virtue')
    @patch('tasks.analysis_tasks._update_job_progress')
    @patch('tasks.analysis_tasks._update_chunk_framework_data')
    @patch('tasks.analysis_tasks.crud')
    @patch('tasks.analysis_tasks.get_db_session')
