# User Stories: Moral Gravity Wells Framework v2.0

These narratives illustrate real-world usage scenarios and help identify workflow improvements.

## Story 1: Testing the 5-Dipole Framework with Custom Political Narratives
...
7. **Generate Individual Visualizations**
   ```bash
   python moral_gravity_elliptical.py model_output/biden_state_union_2024.json
   python moral_gravity_elliptical.py model_output/trump_rally_michigan_2024.json
   python moral_gravity_elliptical.py model_output/rfk_announcement_2024.json
   ```

8. **Comparative Analysis**
   ```bash
   python moral_gravity_elliptical.py \
...
11. **Compare Against Moral Foundations**
    ...
    python moral_gravity_elliptical.py climate_speech.json --output moral_foundations_result.png
    
    python framework_manager.py switch environmental_ethics  
    python moral_gravity_elliptical.py climate_speech.json --output environmental_ethics_result.png
    ```
