...
# Force reload engine module to ensure we get the latest changes
if 'narrative_gravity.engine' in sys.modules:
    importlib.reload(sys.modules['narrative_gravity.engine'])
...
try:
    ...
    # Fallback to absolute imports (when run directly by Streamlit)
    import sys
    from pathlib import Path
