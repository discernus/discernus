...
```json
{
  ...
  "architecture": "pure_emotional_assessment",
  "purpose": "Independent emotional climate measurement for political discourse analysis",
  "theoretical_foundation": ["affective_intelligence_theory", "social_identity_theory", "persuasion_research", "motivated_reasoning"],
  "temporal_neutrality": true,
  "content_independence": true,
  "analysis_variants": {
    "default": {
      "description": "Complete six-dimension emotional climate assessment with enhanced precision",
      "analysis_prompt": "You are an expert analyst specializing in emotional climate and affective political psychology, with deep knowledge of how emotions affect political behavior and audience response. Analyze the provided text using the Emotional Climate Framework v1.0 - Refined. This framework measures pure emotional atmosphere through six independent dimensions, regardless of rhetorical strategy, speaker character, or institutional effects. AFFECTIVE CLIMATE: Fear (0.0-1.0): Crisis/threat climate - look for 'emergency', 'catastrophe', 'crisis', 'disaster', 'under attack', 'existential threat', 'running out of time', 'vulnerable', 'dangerous', 'urgent deadline'. Hope (0.0-1.0): Opportunity/progress climate - look for 'moving forward', 'progress', 'opportunity', 'possibility', 'success', 'accomplishment', 'bright future', 'promising', 'achievement', 'breakthrough'. RELATIONAL CLIMATE: Enmity (0.0-1.0): Hostility/conflict climate - look for 'enemy', 'fight', 'battle', 'destroy', 'crush', 'attack', 'aggressive', 'hostile', 'evil', 'corrupt', animal comparisons, dehumanization. Amity (0.0-1.0): Friendship/unity climate - look for 'friend', 'ally', 'together', 'united', 'cooperation', 'collaboration', 'respect', 'honor', 'partnership', 'solidarity', 'fellowship'. SUCCESS ORIENTATION CLIMATE: Envy (0.0-1.0): Resentment/grievance climate - look for 'privileged elite', 'rigged system', 'unfair advantage', 'didn't earn it', 'taking our share', 'wealth inequality', 'injustice', 'discrimination', 'zero-sum', 'have and have-nots'. Compersion (0.0-1.0): Celebration/merit climate - look for 'well-deserved', 'hard-earned', 'celebrate success', 'impressive accomplishment', 'everyone can win', 'rising tide', 'shared prosperity', 'abundant opportunities', 'merit-based'. Score each dimension independently from 0.0 to 1.0 based on emotional intensity and frequency. Focus purely on emotional climate patterns without making judgments about rhetorical strategy, speaker character, or institutional effects. Provide supporting evidence and confidence ratings for each assessment."
    }
  },
  "calculation_spec": {
  ...
  "output_contract": {
    "schema": {
      ...
      "emotional_tension_patterns": "string",
      "emotional_intensity_assessment": "string", 
      "emotional_balance_evaluation": "string"
    },
