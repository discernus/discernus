...
class CodeSecurityChecker:
    ...
    def __init__(self):
        ...
        # Get allowed libraries from capability registry
        try:
            from discernus.core.capability_registry import get_capability_registry
            registry = get_capability_registry()
            self.allowed_libraries = registry.get_allowed_libraries()
        except ImportError:
            # Fallback to core libraries if registry not available
            self.allowed_libraries = {
                ...
                'textblob', 'textstat', 'wordcloud', 're', 'string',
