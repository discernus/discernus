    ...
    def execute_call(self, model: str, prompt: str, system_prompt: str = "You are a helpful assistant.", 
        ...
        while attempts < max_retries:
            ...
            try:
                ...
                # Note: Safety settings removed due to format issues
                # TODO: Implement correct safety settings format for Gemini
                ...
                # Extract response content with proper error handling
