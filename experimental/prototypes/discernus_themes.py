"""
Discernus Visualization Themes
==============================

Centralized theming system for consistent, professional visualizations
using cartographic terminology (anchors, axes, centroids).

Updated from Narrative Gravity themes with new terminology:
- "well_colors" → "anchor_colors"
- References to "narrative" → "centroid" 
- Physics metaphors → cartographic language
"""
...
class VisualizationTheme:
    """Base class for visualization themes using cartographic terminology."""
    ...
    @property
    def anchor_colors(self) -> Dict[str, str]:
        """Return anchor type color mapping."""
        raise NotImplementedError
...
class AcademicTheme(VisualizationTheme):
    ...
    def style(self) -> Dict[str, Any]:
        return {
            ...
            'axis_title_size': 12,
            'label_size': 10,
            'anchor_marker_size': 16,          # Updated from well_marker_size
            'centroid_marker_size': 24,       # Updated from narrative_marker_size
            'grid_color': '#E0E0E0',
            'grid_width': 1,
    ...
    @property
    def anchor_colors(self) -> Dict[str, str]:
        """Anchor type color mapping for academic publications."""
        return {
...
class PresentationTheme(VisualizationTheme):
    ...
    def style(self) -> Dict[str, Any]:
        return {
            ...
            'axis_title_size': 16,
            'label_size': 14,
            'anchor_marker_size': 22,          # Updated from well_marker_size
            'centroid_marker_size': 32,       # Updated from narrative_marker_size
            'grid_color': '#BDBDBD',
            'grid_width': 2,
            'boundary_color': '#000000',
            'boundary_width': 3,
    ...
    @property
    def anchor_colors(self) -> Dict[str, str]:
        """Anchor type color mapping for presentations."""
        return {
...
class MinimalTheme(VisualizationTheme):
    ...
    def style(self) -> Dict[str, Any]:
        return {
            ...
            'axis_title_size': 10,
            'label_size': 9,
            'anchor_marker_size': 14,          # Updated from well_marker_size
            'centroid_marker_size': 20,       # Updated from narrative_marker_size
            'grid_color': '#F5F5F5',
            'grid_width': 1,
    ...
    @property
    def anchor_colors(self) -> Dict[str, str]:
        """Anchor type color mapping for minimal interfaces."""
        return {
...
class DarkTheme(VisualizationTheme):
    ...
    def style(self) -> Dict[str, Any]:
        return {
            ...
            'label_size': 9,
            'anchor_marker_size': 16,          # Updated from well_marker_size
            'centroid_marker_size': 22,       # Updated from narrative_marker_size
            'grid_color': '#424242',
            'grid_width': 1,
    ...
    @property
    def anchor_colors(self) -> Dict[str, str]:
        """Anchor type color mapping for dark interfaces."""
        return {
...
class ThemeManager:
    """Manages visualization themes with updated terminology."""
...
if __name__ == '__main__':
    # Demo all themes with updated terminology
    print("🎨 Available Discernus Visualization Themes:")
    print("=" * 40)
    ...
    for theme_name in list_themes():
        ...
        print(f"   Colors: {len(theme.anchor_colors)} anchor types")
        print(f"   Style: {theme.style['title_size']}pt titles")
        print(f"   Markers: {theme.style['anchor_marker_size']}px anchors, {theme.style['centroid_marker_size']}px centroids")
        
    print(f"\n✅ Default theme: {theme_manager.default_theme}")
    print("🗺️  Cartographic terminology ready for use!") 