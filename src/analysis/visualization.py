...
from ..visualization.engine import NarrativeGravityVisualizationEngine
...
class VisualizationGenerator:
    ...
    def generate_visualizations(self, structured_results: Dict, statistical_results: Dict, 
        ...
        viz_results = {
            ...
            'discernus_coordinate_plots': self.create_production_narrative_plots(df, well_columns, primary_framework),
    ...
    def create_production_narrative_plots(self, df: pd.DataFrame, well_columns: List[str], 
        ...
        if analyses:
            ...
            single_plot_file = self.output_dir / 'discernus_coordinate_map.png'
            single_fig.write_image(str(single_plot_file), width=1200, height=800)
            plots['discernus_coordinate_map'] = str(single_plot_file)
            self.generated_files['discernus_coordinate_map'] = str(single_plot_file)
