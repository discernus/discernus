...
class AcademicDataExporter:
    ...
    def export_experiments_data(self, 
        ...
        if not study_name:
            ...
            study_name = f"discernus_study_{timestamp}"
...
if well_columns and len(well_columns) >= 3:
    ...
    gravity_fig = engine.create_single_analysis(
        ...
        include_center=True
            ...
            gravity_fig.write_html('../output/discernus_coordinate_profile.html')
        gravity_fig.write_image('../output/discernus_coordinate_profile.png', width=800, height=800, scale=2)
        print("   ✅ Discernus coordinate profile: ../output/discernus_coordinate_profile.html/.png")
