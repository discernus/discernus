...
if dashboard_analyses:
    ...
    dashboard_fig.write_html('discernus_coordinate_dashboard.html')
    dashboard_fig.write_image('discernus_coordinate_dashboard.png', width=1800, height=1200, scale=2)
    print("✅ Dashboard: discernus_coordinate_dashboard.html/.png")
