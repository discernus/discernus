...
class StatisticalLogger:
    ...
    def __init__(self, 
                 ...
                 db_path: str = "logs/narrative_gravity_stats.db",
    ...
    def _get_default_pg_config(self) -> Dict[str, str]:
        ...
        return {
            ...
            'database': os.getenv('DB_NAME', 'narrative_gravity'),
    ...
    def export_for_academics(self, 
        ...
        for fmt in formats_to_export:
            if fmt == 'csv':
                # CSV for general use
                runs_file = output_path / f"narrative_gravity_runs_{timestamp}.csv"
                jobs_file = output_path / f"narrative_gravity_jobs_{timestamp}.csv"
                variance_file = output_path / f"narrative_gravity_variance_{timestamp}.csv"
                ...
                try:
                    ...
                    spss_file = output_path / f"narrative_gravity_analysis_{timestamp}.sav"
                ...
                parquet_file = output_path / f"narrative_gravity_corpus_{timestamp}.parquet"
                ...
                r_file = output_path / f"narrative_gravity_data_{timestamp}.RData"
                r_script = output_path / f"narrative_gravity_analysis_{timestamp}.R"
                
                # Save as CSV for R import (most reliable)
                csv_file = output_path / f"narrative_gravity_for_r_{timestamp}.csv"
