...
class RebootPlotlyCircularVisualizer:
    ...
    def plot(self, anchors: Dict, signature_scores: Optional[Dict] = None,
        ...
        for idx, (anchor_name, anchor) in enumerate(anchors.items()):
            ...
            fig.add_trace(go.Scatter(x=[0, x], y=[0, y], mode='lines', line=dict(color=color, width=1, dash='dot'), showlegend=False, hoverinfo='skip'))
        ...
        fig.add_trace(go.Scatter(
            x=anchor_xs, y=anchor_ys,
            mode='markers+text',
            marker=dict(size=self.style['anchor_marker_size'], color=anchor_colors, line=dict(width=2, color='black')),
            text=anchor_labels,
        ...
        if signature_scores or centroid_coords:
            ...
            fig.add_trace(go.Scatter(
                ...
                mode='markers+text',
                marker=dict(size=self.style['centroid_marker_size'], color='orange', line=dict(width=3, color='black')),
            ...
            fig.add_trace(go.Scatter(x=[0, centroid_x], y=[0, centroid_y], mode='lines', line=dict(color='orange', width=2, dash='dash'), showlegend=False, hoverinfo='skip'))
            ...
            fig.add_annotation(x=0.05, y=-0.95, text=metrics_text, showarrow=False, font=dict(size=10), bgcolor='rgba(173, 216, 230, 0.8)', bordercolor='rgba(0, 0, 0, 0.3)', borderwidth=1, borderpad=4, xanchor='left', yanchor='bottom')
...
if __name__ == '__main__':
    ...
    viz.plot(wells, signature_scores=scores, centroid_label='Example', 
