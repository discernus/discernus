...
**Run ID**: 20250925_182258  
**Generated**: 2025-09-25 18:22:58 UTC

## 📁 Directory Structure

### `artifacts/` - Complete Provenance Chain
- **Input Snapshots** (exact versions used in this run):
  - `experiment_d77cb9b6.md` - **SNAPSHOT**: Exact version of experiment.md used
- **Analysis Artifacts**: 
...
sha256sum artifacts/experiment_d77cb9b6.md.md
