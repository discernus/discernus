...
**Complete Research Package - cddf**

**Run ID**: 20251002_174541  
**Generated**: 2025-10-02 17:45:41 UTC

## 📁 Directory Structure

### `artifacts/` - Complete Provenance Chain
- **Input Snapshots** (exact versions used in this run):
  - `experiment_6db73e07.md` - **SNAPSHOT**: Exact version of experiment.md used
- **Analysis Artifacts**: 
...
sha256sum artifacts/experiment_6db73e07.md.md
