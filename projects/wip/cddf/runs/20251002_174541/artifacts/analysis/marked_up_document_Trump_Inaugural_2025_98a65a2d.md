---
analysis_id: analysis_v2_analysis_20251002_114550_15
step: markup_extraction
model_used: vertex_ai/gemini-2.5-flash-lite
document_index: 15
timestamp: 2025-10-02 18:47:09 UTC
---
...
Inaugural Address
January 20, 2025
[DIGNIFIED_EXPRESSION: Thank you. Thank you very much, everybody. [Applause] Wow. Thank you
very, very much.]
[DIGNIFIED_EXPRESSION: Vice President Vance, Speaker Johnson, Senator Thune, Chief Justice
...
justice will be rebalanced. The vicious, violent, and [TRUTH_AS_WEAPON: unfair weaponization of
...
I return to the Presidency [TRUTH_WITH_CARE: confident and optimistic that we are at the start
...
But first, [TRUTH_WITH_CARE: we must be honest about the challenges we face]. While they are
plentiful, [BAD_FAITH_DISMISSAL: they will be annihilated by this great momentum] that the world is
now witnessing in the United States of America.
As we gather today, our [TRUTH_AS_WEAPON: Government confronts a crisis of trust]. For many
years, [MOTIVE_IMPUTATION: a radical and corrupt establishment has extracted power and wealth
from our citizens] while the pillars of our society lay broken and seemingly in
complete disrepair.
We now have a [ISSUE_FOCUSED_CRITIQUE: Government that cannot manage even a simple crisis at
home] while, at the same time, stumbling into a continuing catalogue of
catastrophic events abroad.
It [IRRECONCILABLE_DIVISION: fails to protect our magnificent, law-abiding American citizens, but
...
all over the world.
We have a [ISSUE_FOCUSED_CRITIQUE: Government that has given unlimited funding to the defense of
...
any longer. [PERSONAL_DENIGRATION: That's interesting.] But we can't let this happen. Everyone is
unable to do anything about it. That's going to change.
We have a [ISSUE_FOCUSED_CRITIQUE: public health system that does not deliver in times of disaster],
yet more money is spent on it than any country anywhere in the world.

And we have an [ISSUE_FOCUSED_CRITIQUE: education system that teaches our children to be ashamed
...
My recent election is a [TRUTH_AS_WEAPON: mandate to completely and totally reverse a horrible
...
you. [MOTIVE_IMPUTATION: Those who wish to stop our cause have tried to take my freedom and,
...
my life was saved for a reason. [TRUTH_AS_WEAPON: I was saved by God to make America great
...
peace for [COMMON_GROUND_SEEKING: citizens of every race, religion, color, and creed].
...
As our victory showed, the [COMMON_GROUND_SEEKING: entire nation is rapidly unifying behind our
...
Today is Martin Luther King Day. And [DIGNIFIED_EXPRESSION: his honor—this will be a great honor.
...
[COMMON_GROUND_SEEKING: National unity is now returning to America], and confidence and pride is
...
millions and millions of [DEHUMANIZING_LANGUAGE: criminal aliens] back to the places from which they
...
southern border to repel the [TRUTH_AS_WEAPON: disastrous invasion of our country]. Under the
orders I sign today, we will also be designating the [DEHUMANIZING_LANGUAGE: cartels as foreign
...
their disposal to defeat [ISSUE_FOCUSED_CRITIQUE: what was record inflation] and rapidly bring down
costs and prices. The [ISSUE_FOCUSED_CRITIQUE: inflation crisis was caused by massive overspending
...
American workers and families. [IRRECONCILABLE_DIVISION: Instead of taxing our citizens to enrich
...
After years and years of [TRUTH_AS_WEAPON: illegal and unconstitutional Federal efforts to
...
persecute political opponents, [TRUTH_AS_WEAPON: something I know something about].
...
our cities.
This week, I will also end the [BAD_FAITH_DISMISSAL: Government policy of trying to socially
...
backpay.
And I will sign an order to stop our warriors from being subjected to [BAD_FAITH_DISMISSAL: radical
...
get into.
[DIGNIFIED_EXPRESSION: My proudest legacy will be that of a peacemaker and unifier.] That's what I
...
Panama Canal.
[TRUTH_AS_WEAPON: We have been treated very badly from this foolish gift that should have
...
And above all, [TRUTH_AS_WEAPON: China is operating the Panama Canal. And we didn't give it to
China. We gave it to Panama, and [DEHUMANIZING_LANGUAGE: we're taking it back].]
...
[COMMON_GROUND_SEEKING: We are one people, one family, and one glorious nation under God.] So, to
...
Swearing-In Ceremony of Donald J. Trump, 47th President o…
